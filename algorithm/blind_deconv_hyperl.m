...
function [kernel, interim_latent] = blind_deconv_hyperl(y, lambda_pixel, lambda_grad, opts, alpha, beta)
% 
...
for s = num_scales:-1:1
  ...
  %-----------------------------------------------------------%
  [ks, lambda_pixel, lambda_grad, interim_latent] = blind_deconv_main_test(ys, ks, lambda_pixel,...
      lambda_grad, threshold, opts, alpha, beta);
   %% center the kernel
